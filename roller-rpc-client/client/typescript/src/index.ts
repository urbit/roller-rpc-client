 ...
 *
 */
export type  = Ship | EthAddress | Signature | From | TransferPointParams | SpawnParams | ConfigureKeysParams | SponsorshipParams | AddressParams | Hash32 | TransactionType | Point | Points | Hash | ListOfPendingTxs | SpawnedPoints | NextBatch | TransactionStatus | AddressHistory | Nonce | Success | Config | ListOfDNS;
export type GetPoint = (ship: Ship) => Promise<Point>;
export type GetPoints = (address: EthAddress) => Promise<Points>;
export type TransferPoint = (sig: Signature, from: From, data: TransferPointParams) => Promise<Hash>;
export type Spawn = (sig: Signature, from: From, data: SpawnParams) => Promise<Hash>;
export type ConfigureKeys = (sig: Signature, from: From, data: ConfigureKeysParams) => Promise<Hash>;
export type Escape = (sig: Signature, from: From, data: SponsorshipParams) => Promise<Hash>;
export type CancelEscape = (sig: Signature, from: From, data: SponsorshipParams) => Promise<Hash>;
export type Adopt = (sig: Signature, from: From, data: SponsorshipParams) => Promise<Hash>;
export type Detach = (sig: Signature, from: From, data: SponsorshipParams) => Promise<Hash>;
export type Reject = (sig: Signature, from: From, data: SponsorshipParams) => Promise<Hash>;
export type SetManagementProxy = (sig: Signature, from: From, data: AddressParams) => Promise<Hash>;
export type SetSpawnProxy = (sig: Signature, from: From, data: AddressParams) => Promise<Hash>;
export type SetTransferProxy = (sig: Signature, from: From, data: AddressParams) => Promise<Hash>;
