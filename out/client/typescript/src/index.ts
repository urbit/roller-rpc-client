...
export type L2TransactionCommonParams =
  | ConfigureKeysParams
  | SpawnParams
  | ConfigureKeysParams
  | SponsorshipParams
...
export type ConfigureKeys = (
  sig: Signature,
  from: From,
  data: ConfigureKeysParams
) => Promise<Hash>;
export type Escape = (
  sig: Signature,
  from: From,
  data: SponsorshipParams
) => Promise<Hash>;
export type CancelEscape = (
  sig: Signature,
  from: From,
  data: SponsorshipParams
) => Promise<Hash>;
...
export type SetManagementProxy = (
  sig: Signature,
  from: From,
  data: AddressParams
) => Promise<Hash>;
export type SetSpawnProxy = (
  sig: Signature,
  from: From,
  data: AddressParams
) => Promise<Hash>;
export type SetTransferProxy = (
  sig: Signature,
  from: From,
  data: AddressParams
) => Promise<Hash>;
...
export type GetPendingByAddress = (
  address: EthAddress
) => Promise<ListOfPendingTxs>;
...
export class RollerRPCAPI {
  ...
  public static openrpcDocument: OpenRPC = {
    ...
    servers: [
      ...
      {
        url: "https://rollup.tlon.network/v1/azimuth",
        name: "Tlon L2 Roller",
        description: "TBD",
      },
    ],
    methods: [
      {
            ...
            schema: {
              ...
              anyOf: [
                ...
                },
                {
                  type: "number",
                  title: "Number",
                  description: "number representing a patp",
                },
              ],
            },
          },
          ...
          schema: {
            ...
            properties: {
              ...
              ownership: {
                title: "Ownership",
                type: "object",
                required: ["life", "pass", "rift", "sponsor"],
                properties: {
                  life: { type: "number", title: "Life" },
                  pass: { type: "string", title: "Pass" },
                  rift: { type: "number", title: "Rift" },
                  sponsor: {
                    title: "Sponsor",
                    type: "object",
                    properties: {
                      has: { type: "boolean", title: "Forced" },
                      who: { type: "string", title: "string_doaGddGA" },
                    },
                  },
                  escape: { type: "string", title: "string_doaGddGA" },
                },
              },
            },
          },
        ...
        examples: [
          {
            name: "getPoint-example",
            params: [{ name: "ship", value: "~norsyr-torryn" }],
            description:
              'Retrieve Azimuth Point information from the rollup for ~norsyr-torryn. \nExample: \n`curl -X POST --data \'{"jsonrpc": "2.0","method": "getPoint","params": {"ship": "~norsyr-torryn"},"id": 1}\' http://localhost:8080/v1-azimuth`',
            result: {
              name: "getPoint-result-example",
              value: {
                dominion: "l2",
                ownership: {
                  transferProxy: {
                  ...
                  votingProxy: { address: "0x00000000000000000000", nonce: 0 },
                  spawnProxy: { address: "0x00000000000000000000", nonce: 0 },
                  managementProxy: {
                    address: "0x00000000000000000000",
                    nonce: 0,
                  },
                ...
                network: {
                  keys: { life: 0, suite: 0, auth: 0, crypt: 0 },
                  sponsor: { has: true, who: "marzod" },
                  rift: 0,
                },
              },
            },
        ...
        params: [
          {
            name: "address",
            summary:
              "Ethereum address (e.g. 0xf48062ae8bafd6ef19cd6cb89db93a0d0ca6ce26",
            required: true,
            schema: {
              title: "eth-address",
              description: "hex encoded address",
        ...
        examples: [
          {
            ...
            params: [
              {
                name: "address",
                value: "0xf48062ae8bafd6ef19cd6cb89db93a0d0ca6ce26",
              },
            ],
            description:
              "Retrieve all points controlled by 0xf48062ae8bafd6ef19cd6cb89db93a0d0ca6ce26`",
            result: {
              name: "points",
              value: [
                {
          ...
          },
          {
            ...
            schema: {
              ...
              properties: {
                ...
                reset: { type: "boolean", title: "Reset" },
              },
            },
          },
        ],
        ...
        params: [
          ...
          },
          {
            ...
            schema: {
              ...
              properties: {
                encrypt: { type: "string", title: "string_doaGddGA" },
                auth: { type: "string", title: "string_doaGddGA" },
                cryptoSuite: { type: "string", title: "string_doaGddGA" },
                breach: { type: "boolean", title: "Breach" },
              },
            },
          },
        ],
        ...
        result: {
          ...
          schema: {
            ...
            items: {
              ...
              properties: {
                forced: { type: "boolean", title: "Forced" },
                tx: {
                  ...
                  properties: {
                    ...
                    tx: {
                      title: "L2-Transaction-Common-Params",
                      anyOf: [
                        {
                          title: "ConfigureKeysParams",
                          type: "object",
              ...
              value: [
                {
                  rawTx: {
                    tx: {
                      ...
                      from: { ship: "wanzod", proxy: "own" },
                    },
                    sig: "0x2c50e233a62fe1ae4a0f62c18585a245412fc498f0598aae0e4254a2c268038d18e9c7d35b3bb3b7c441f43bd8a7b960d1271b5ecbeb5f86e9e4e3c2b5d15ace00",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
                {
                  rawTx: {
                    ...
                    sig: "0xec4bd500e4cbb24dcc9d929e432306847bcfb5a8c9c927faa69e57972cd560392df57e4e3be1ae180be5f79bfa952200176ca908c7aa8992141da15271631e6300",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
                {
                  rawTx: {
                    ...
                    sig: "0x23fbdf91c692ddf2cdab4a0f93d84fe1e1c65a5b94db7c2505e26b815261f35949f331a3e2dfe9375e50404ffecf35818874317113f7ea594fc90d834690ab8d01",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
                {
                  rawTx: {
                    ...
                    sig: "0x303fd3858367acb6e095769fce66946ccbfda9fad3a6468b6593b23b6da893855d94c557d18e0f3cf09cf00989f806b547afcc062cd76fe2c555b0e677fee10e00",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
                {
                  rawTx: {
                    ...
                    sig: "0xb369cba5148dc6118bb6b36946a183359942dfea3e5028a98c64d0a578d25ee22c7cc8552af48dbeb151a9de4f9290272cd174dc1fc4dc726577247d752dc02e01",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
                {
                  rawTx: {
                    ...
                    sig: "0x79f215fe0908a45ac11cc1e7b100ad4664e1312f70dfe1412f564a60ad4dc98059717e7307386ad0b79a86cc12801ccc6d067db96e05e2d1471aeeb93c64584300",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
                {
                  rawTx: {
                    ...
                    sig: "0x87e7000764ec25246020c43b681359653dd6ac31ff88e1566e807e0b2a0784e416bedd403bbe789fed8efc59b5bd191896524fd260def064cb2ac249e284e36e00",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
                {
                  rawTx: {
                    ...
                    sig: "0xa11b0073b5630cf7725e17b901ce213cc217fdb8e313bc1eae8fefe2ea5283496a7aaa3a8c5497a0e45378823dddae4dd2f39271b15b29ce8e9b6f9df0da37f801",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
                {
                  rawTx: {
                    ...
                    sig: "0xd3bb588020ac3f355d87a005ce04cd2a2903e2a14d539e1c3c2cca768998a35d32d48add815efcd97453a551fffa3c2526c6dce504e6630cbb17a57f575b009200",
                  },
                  address: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
                  force: false,
                },
        ...
        examples: [
          {
            ...
            params: [
              {
                name: "address",
                value: "0x6deffb0cafdb11d175f123f6891aa64f01c24f7d",
              },
            ],
            description: "",
            result: {
      ...
      },
      {
        ...
        result: {
          name: "spawned points",
          description:
            "List of spawned points and the ownership ethereum address",
          schema: {
            type: "array",
            title: "SpawnedPoints",
            items: {
              ...
              properties: {
                ...
                ship: {
                  type: "string",
                  title: "ShipName",
                  description: "Ship encoded as a patp without leading sig",
                },
              },
            },
          },
      ...
      },
      {
        ...
        examples: [
          {
            name: "next-batch-example",
            params: [],
            result: { name: "batch", value: 1623672000000 },
          },
        ],
        result: {
          name: "Next batch",
            ...
            params: [
              {
                name: "hash",
                value:
                  "0x4a74c4e92a3cd72cf7dcb68a56fa06ea883c530861497b11b0e03a536cfd2b0b",
              },
            ],
            result: { name: "status", value: "confirmed" },
          },
        ],
        result: {
          name: "Status",
              ...
              value: [
                {
                  ...
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x99bb2265705db3228a07c8b76603de923fcb69662fe2844dc6eb083d1feb34ee",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x5c4a29668d21674ab9909a5cdd1de718b055764640b67a5181a003956992c076",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x4e15ff81cf9d0cb7c936ee1a43827764ba0864cfa0682e168888da18589bd7bd",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xf93f2e2ff1be2be4c89cd5460cab710cc698f61038e46982d37894bfb4152b52",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xd3d650daf12b376abd4f1c6e09e3e5028a2a04116d94c8a24ac4fca38e3d49db",
                },
                {
                  status: "confirmed",
                  type: "spawn",
                  hash: "0x311560d19e9ba6b9e1f0d12b4f321a13595d339eee19a7fb5079d3521e2fcd42",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xcf9f0596d143a7b47ce545f5dacf932fa356a7d017603c6bddb502be35a72e27",
                },
                {
                  status: "pending",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x4a74c4e92a3cd72cf7dcb68a56fa06ea883c530861497b11b0e03a536cfd2b0b",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x15586ba773fbc858e15fa29af42b093a1006009924b41c504b1aca8f9adc7534",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xdca5272fcf78c19905c0f69f23ef64a7ee123552c68ec73fc84c180c5aa8d6f9",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xe5919e730682356484f2a20913e0e06cb8f6e53a250b329186d7df764d2f9c11",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xfd9055547985e174539a3c83fb429b051cc95fdc0ce7f8c3b1ccd87bc4661e8d",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xda681585f2a342a49f1f459330b813d7e59baebf60425a8f17c37c7769570459",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x9b01e5fe2a366bec8de56806ad8e41306bcefd849775ecdecd4b0b8d5032a34e",
                },
                {
                  status: "confirmed",
                  type: "spawn",
                  hash: "0xab0e73a07015adbd667f5b7498267854d5fc03cfb05cf7180429f90dae88fc0",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xf7f7fd97b5618fbb66ddc170917c2734d59c3aa339591fcfbdb414e0d337dd7f",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xdffcb5dcf7dd19d8d57a71ff2c342e09d773ef4cf886d4fd6b3c0e2a745d7394",
                },
                {
                  status: "pending",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x2e989af50ed43d936b5339d2d9a11d72b58644c6da348d97ecb7ff05dc67702c",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x36a8432358c0c960d2850d048f57e0ceaf98860958ac67d4420a8d8dd1d940cf",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x50e6745917033c473aeda58f59c20956f57e835841e5abc1987dad60f4321133",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x54da669d6a377cad15006b2b5467386675d825119272f27ea384d8d9c029dfd6",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xb84a941b60ce0b2fa5620d0614c52c4debada451452e22b781d571550781572e",
                },
                {
                  status: "pending",
                  ship: "~sampel-palnet",
                ...
                },
                {
                  ...
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xcdee99e5dc235a7af2f1d4176a3dea8821ad959719d561f4c570b2bf1f2e1dd3",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0xd04c2b4008e4abea15f047487904241d348493643a64ef0bb01d3cba4f3550ad",
                },
                {
                  status: "confirmed",
                  ship: "~sampel-palnet",
                  type: "spawn",
                  hash: "0x8dad6e8aa1ef58efb99c4a01210e79d16e4f46eb2bb602d4c8f15ab3b8957e64",
                },
              ],
            },
          },
      ...
      {
        name: "getNonce",
        summary: "Current nonce used by the Roller",
        paramStructure: "by-name",
        params: [],
        examples: [
          {
            name: "nonce-example",
            params: [],
            result: { name: "nonce", value: 18 },
          },
        ],
        result: { name: "Nonce", schema: { type: "number", title: "Nonce" } },
      },
      {
            ...
            params: [
              {
                name: "sig",
                value:
                  "0x84b657f38d4d7286ae8cd847bea8cde9f36d8c17373ece99ae266b11200abb4218b4f47c5a122086bb15a66acff95ba28f5c7a7ec28ca6cfc0a6f835d8d5ff7f00",
              },
              {
                name: "hash",
                value:
                  "0x2461e96f0d709c42f24646a8de1ea13c67ef8a7276e6fa0c03573947e496656f",
              },
              { name: "type", value: "spawn" },
              { name: "ship", value: "~rammel-wisrex" },
            ],
            result: { name: "ok", value: "ok" },
          },
        ],
        result: {
          name: "success",
        ...
        examples: [
          {
            ...
            result: {
              name: "config",
              value: {
                contract: "0x56db68f29203ff44a803faa2404a44ecbb7a7480",
                refreshTime: 300,
                nextBatch: 1624946400000,
                frequency: 3600,
                chainId: 1337,
              },
            },
          ...
          properties: {
            ...
            proxy: {
              ...
              anyOf: [
                ...
                { pattern: "/^spawn$/", type: "string", title: "SpawnProxy" },
                { pattern: "/^vote$/", type: "string", title: "VotingProxy" },
                {
                  pattern: "/^manage$/",
                  type: "string",
                  title: "ManagementProxy",
  ...
  private request(methodName: string, params: any[]): Promise<any> {
    const methodObject = _.find(
      RollerRPCAPI.openrpcDocument.methods as MethodObject[],
